...
`,S=()=>{document.getElementById("send-form").addEventListener("submit",e=>{e.preventDefault();const o=h(new Date),i=document.getElementById("send-input");if(!i.value)return;const s=document.getElementById("chat");s.innerHTML+=j(i.value,o);let d="...";const l=`${Date.now()}`;s.innerHTML+=C(d),I(i.value).then(c=>{const f=h(new Date),v=document.getElementById(`time${l}`);v.innerHTML=f;const k=document.getElementById(l);k.innerHTML=c}).catch(c=>alert(c)),i.value=""})},I=n=>new Promise((o,i)=>{setTimeout(()=>{o(n)},1e3)}),A=()=>{const n=document.querySelector(".chat"),e=new MutationObserver(O),o={childList:!0};e.observe(n,o)};function O(){chat.scrollTop=chat.scrollHeight}function h(n){var e=n.getHours(),o=n.getMinutes(),i=e>=12?"pm":"am";e=e%12,e=e||12,o=o<10?"0"+o:o;var s=e+":"+o+" "+i;return s}const C=(n,e=`${Date.now()}`)=>`
