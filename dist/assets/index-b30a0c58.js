var y=Object.defineProperty;var L=(n,e,o)=>e in n?y(n,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):n[e]=o;var p=(n,e,o)=>(L(n,typeof e!="symbol"?e+"":e,o),o);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const d of s)if(d.type==="childList")for(const l of d.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&i(l)}).observe(document,{childList:!0,subtree:!0});function o(s){const d={};return s.integrity&&(d.integrity=s.integrity),s.referrerPolicy&&(d.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?d.credentials="include":s.crossOrigin==="anonymous"?d.credentials="omit":d.credentials="same-origin",d}function i(s){if(s.ep)return;s.ep=!0;const d=o(s);fetch(s.href,d)}})();const c="#a16dfd",t={defaultColor:c,backgroundColor:"white",borderColor:"#E8E8E8",questionBackgroundColor:c,questionTextColor:"white",responseBackgroundColor:"#EDEDEF",responseTextColor:"#5F5968",popupBackgroundColor:"white",closePopupColor:"#B3ABC2",dropdownBackground:"#EDEDEF",dropdownBorder:"none",dropdownSelectedTextColor:c,dropdownTextColor:"#5F5968",boxMuted:"#A599BA",boxHighlighted:c,inputBackground:"#F6F7F9",inputBorder:"#E8E8E8",inputColor:"#5F5968",scrollbarBackground:"#EDEDEF",scrollbarThumb:"#A599BA"},r={defaultColor:c,backgroundColor:"#272727",borderColor:"#454545",questionBackgroundColor:c,questionTextColor:"white",responseBackgroundColor:"#454545",responseTextColor:"#F4F4F4",popupBackgroundColor:"#383838",closePopupColor:"#8F8F8F",dropdownBackground:"#4A4A4A",dropdownBorder:"1px solid #565656",boxMuted:"#898989",boxHighlighted:"white",dropdownSelectedTextColor:"white",dropdownTextColor:"#C4C4C4",inputBackground:"#454545",inputBorder:"#636363",inputColor:"#C4C4C4",scrollbarBackground:"#4F4F4F",scrollbarThumb:"#8A8592"};window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches;const _=`
    .widget__container * {
...
`,S=()=>{document.getElementById("send-form").addEventListener("submit",e=>{e.preventDefault();const o=h(new Date),i=document.getElementById("send-input");if(!i.value)return;const s=document.getElementById("chat");s.innerHTML+=F(i.value,o);let d="...";const l=`${Date.now()}`;s.innerHTML+=C(d),I(i.value).then(a=>{const f=h(new Date),v=document.getElementById(`time${l}`);v.innerHTML=f;const k=document.getElementById(l);k.innerHTML=a}).catch(a=>alert(a)),i.value=""})},I=n=>new Promise((o,i)=>{setTimeout(()=>{o(n)},1e3)}),A=()=>{const n=document.querySelector(".chat"),e=new MutationObserver(O),o={childList:!0};e.observe(n,o)};function O(){chat.scrollTop=chat.scrollHeight}function h(n){var e=n.getHours(),o=n.getMinutes(),i=e>=12?"pm":"am";e=e%12,e=e||12,o=o<10?"0"+o:o;var s=e+":"+o+" "+i;return s}const C=(n,e=`${Date.now()}`)=>`
...
`;class z{constructor(e,o,i=null){this.items=e,this.current=i,this.container=document.getElementById(o),this.current||(this.current=e[0]),this.show(),u(V)}show(){const e=document.createElement("div");e.innerHTML=this.html(),e.classList.add("dropdown-container"),e.addEventListener("click",o=>{this.justChanged?this.justChanged=!1:this.expand()}),this.container.appendChild(e)}html(){return`<div class="dropdown">
      <div class="dropdown-data closed">
        <h4>${this.current}</h4>
        ${H}
      </div>
    </div>
    `}expand(){const e=document.getElementsByClassName("dropdown-data")[0];e.classList.remove("closed"),e.classList.add("open");const o=this.items.map(d=>`<div class="dropdown-item${d===this.current?" selected":""}">
        <h4>${d}</h4>
        <span>
          ${d===this.current?T:""}
        </span>
      </div>`);e.innerHTML=o.join(""),document.getElementsByClassName("switch-model-container")[0].classList.add("expand"),document.querySelectorAll(".dropdown-item").forEach(d=>{d.addEventListener("click",l=>{const a=d.querySelector("h4").textContent;this.current=a,this.close()})})}close(){document.getElementsByClassName("switch-model-container")[0].classList.remove("expand");const o=document.getElementsByClassName("dropdown-container")[0];this.container.removeChild(o),this.justChanged=!0,this.show(),document.getElementsByClassName("switch-model-container")[0].classList.remove("active"),g("close")}}const m=["model1","model2","model3","model4"],N=`<div class="switch-model" id="switch-model">
...
`;class P{constructor(){this.switchModelContainer=document.createElement("div"),this.switchModelContainer.innerHTML=N,this.switchModelContainer.classList.add("switch-model-container"),this.showSwitchModel=!1,this.current=m[0]}addSwitchModel(){document.getElementById("send-form-container").prepend(this.switchModelContainer),new z(m,"switch-model",this.current),u(q)}setUpListeners(){this.addSwitchModel();const e=document.getElementById("box-button"),o=document.getElementById("close-switch-model");e.addEventListener("click",i=>this.toggleShowSwitchModel()),o.addEventListener("click",i=>this.toggleShowSwitchModel(!0))}toggleShowSwitchModel(e=!1){this.showSwitchModel=!this.showSwitchModel;const o=document.getElementsByClassName("switch-model-container")[0];this.showSwitchModel&&!e||!o.classList.contains("active")?(o.classList.add("active"),g("open")):(o.classList.remove("active"),g("close"))}}function g(n="close"){const e=document.getElementsByClassName("box-icon");Array.from(e).forEach(o=>{n==="open"?o.classList.add("selected"):o.classList.remove("selected")})}class Z{constructor(e="bottom-right"){p(this,"position","");p(this,"open",!1);p(this,"widgetContent",null);var i;this.position=this.getPosition(e),this.open=!1;const o=(i=document.getElementById("majicai-chatbot"))==null?void 0:i.getAttribute("data-chat-bot-id");console.log("Chatbot Id -",o),this.switchModel=new P,this.initialize(),this.injectStyles(),this.switchModel.setUpListeners(),S(),A()}getPosition(e){const[o,i]=e.split("-");return{[o]:"30px",[i]:"30px"}}async initialize(){const e=document.createElement("div");e.style.position="fixed",Object.keys(this.position).forEach(d=>e.style[d]=this.position[d]),document.body.appendChild(e);const o=document.createElement("button");o.classList.add("button__container");const i=document.createElement("span");i.innerHTML=b,i.classList.add("widget__icon"),this.widgetIcon=i;const s=document.createElement("span");s.innerHTML=$,s.classList.add("widget__icon","widget__hidden"),this.closeIcon=s,o.appendChild(this.widgetIcon),o.appendChild(this.closeIcon),o.addEventListener("click",this.toggleOpen.bind(this)),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("widget__hidden","widget__container"),this.createWidgetContent(),e.appendChild(this.widgetContainer),e.appendChild(o)}createWidgetContent(){this.widgetContainer.innerHTML=j}injectStyles(){const e=document.createElement("style");e.innerHTML=_.replace(/^\s+|\n/gm,""),document.head.appendChild(e),u(D)}toggleOpen(){this.open=!this.open,this.open?(this.widgetIcon.classList.add("widget__hidden"),this.closeIcon.classList.remove("widget__hidden"),this.widgetContainer.classList.remove("widget__hidden")):(this.widgetIcon.classList.remove("widget__hidden"),this.closeIcon.classList.add("widget__hidden"),this.widgetContainer.classList.add("widget__hidden"))}}function R(){return new Z}R();
